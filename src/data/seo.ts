...
export const seoRoutes: Record<string, SeoRoute> = {
  ...
  '/admissions/': {
    ...
    description: 'Ask about current recovery housing availability for adult men and women with New Beginnings in Pittsburgh.',
    pageName: 'Admissions',
    pageType: 'WebPage',
  ...
  '/referrals/': {
    documentTitle: 'Information for Professionals | New Beginnings Pittsburgh',
    description: 'Information for probation officers, social workers, case managers, treatment providers, courts, and community partners exploring New Beginnings recovery housing.',
  ...
  '/support-us/': {
    ...
    description: 'Make a financial contribution to support nonprofit recovery housing for adult men and women in Pittsburgh.',
  ...
  '/contact/': {
    ...
    description: 'Contact New Beginnings about recovery housing availability, professional questions, nonprofit partnerships, or general organization questions.',
